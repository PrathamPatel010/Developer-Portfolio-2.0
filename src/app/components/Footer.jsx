...
const Footer = () => {
  return (
    <>
      <section
        id="socials"
        className="text-slate-100 py-10 md:py-15 bg-gradient-to-b from-[#141517] via-[#101112] to-[#0b0b0c] border-t border-gray-700"
      >
        ...
        <div className="pt-6 text-slate-500 text-center text-sm">
          <small>© 2026 Pratham Patel. All rights reserved.</small>
        </div>
      </section>
    </>
  );
